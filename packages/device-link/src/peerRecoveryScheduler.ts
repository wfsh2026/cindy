...
export interface PeerRecoverySchedulerOptions {
  ...
  /** Desktop retries must not keep the Node process alive. */
  unrefRetryTimers?: boolean;
  retryBaseMs?: number;
  retryMaxMs?: number;
...
export class PeerRecoveryScheduler {
  ...
  private readonly unrefRetryTimers: boolean;
  ...
  constructor(
    ...
    this.unrefRetryTimers = options.unrefRetryTimers ?? false;
