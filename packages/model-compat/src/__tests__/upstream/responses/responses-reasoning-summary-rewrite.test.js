...
import { createReasoningSummaryChannelPayloadRewrite, routeUsesContentChannelReasoning, rewriteReasoningSummaryInJson, rewriteReasoningSummaryInJsonString, } from "../../../upstream/server/responses-reasoning-summary-rewrite";
...
describe("responses reasoning summary channel rewrite", () => {
    ...
    test("rewrites reasoning items inside a bare completed response document", () => {
        ...
        const result = rewriteReasoningSummaryInJson(doc);
...
describe("routeUsesContentChannelReasoning", () => {
    ...
    test("preserveReasoningContentModels lists qualify", () => {
        expect(routeUsesContentChannelReasoning({ preserveReasoningContentModels: ["deepseek-v4-flash"] }, "deepseek-v4-flash")).toBe(true);
    });
