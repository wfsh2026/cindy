...
tab: import
---
If you already have Codex or Claude Code conversations on disk (from the CLIs), Import brings them into Cartethyia so they show up in the sidebar alongside your other sessions.
...
- Imported threads are read-only history at first; you can continue them just like any other Cartethyia session.
