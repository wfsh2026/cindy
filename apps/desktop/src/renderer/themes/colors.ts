...
const optionalModelProviderDefaults = { light: null, dark: null };
registerColor('model-item-selected-bg', optionalModelProviderDefaults, 'Optional model picker selected background');
registerColor('model-item-selected-border', optionalModelProviderDefaults, 'Optional model picker selected border');
registerColor('model-provider-xd', optionalModelProviderDefaults, 'Optional XD model provider identity');
registerColor('model-provider-openai', optionalModelProviderDefaults, 'Optional OpenAI model provider identity');
registerColor('model-provider-anthropic', optionalModelProviderDefaults, 'Optional Anthropic model provider identity');
registerColor('model-provider-google', optionalModelProviderDefaults, 'Optional Google model provider identity');
registerColor('model-provider-custom-1', optionalModelProviderDefaults, 'Optional custom model provider identity 1');
registerColor('model-provider-custom-2', optionalModelProviderDefaults, 'Optional custom model provider identity 2');
registerColor('model-provider-custom-3', optionalModelProviderDefaults, 'Optional custom model provider identity 3');
