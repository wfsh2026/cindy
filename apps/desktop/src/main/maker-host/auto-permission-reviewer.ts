...
export function buildAutoPermissionReviewPrompt(request: AutoReviewRequest): string {
  ...
  return [
    ...
    AUTO_REVIEW_CONTINUATION_POLICY,
    "3. VERDICT:",
    "- allow read-only discovery of available tools and their schemas. Learning which helpers exist",
    "  does not expand task scope, even when the user did not name the helper or scheduler.",
