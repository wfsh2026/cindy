...
const messages = {
  "zh-TW": {
    ...
    resendCode: "重新發送驗證碼",
    captchaTitle: "安全驗證",
    captchaFailed: "安全驗證載入失敗，請檢查網路後重試。",
    captchaRetry: "重試",
    captchaCancel: "取消",
  ...
  "zh-CN": {
    ...
    resendCode: "重新发送验证码",
    captchaTitle: "安全验证",
    captchaFailed: "安全验证加载失败，请检查网络后重试。",
    captchaRetry: "重试",
    captchaCancel: "取消",
  ...
  en: {
    ...
    captchaFailed: "Couldn't load the security check. Check your network and try again.",
    captchaRetry: "Retry",
  ...
  ja: {
    ...
    captchaFailed: "セキュリティチェックを読み込めませんでした。ネットワークを確認して再試行してください。",
    captchaRetry: "再試行",
    captchaCancel: "キャンセル",
  ...
  ko: {
    ...
    captchaTitle: "보안 확인",
    captchaFailed: "보안 확인을 불러오지 못했습니다. 네트워크를 확인한 후 다시 시도해 주세요.",
    captchaRetry: "다시 시도",
    captchaCancel: "취소",
...
export const authErrorMessages: Record<string, Record<LoginLocale, string>> = {
  ...
  SSO_LOGIN_REQUIRED: {
    "zh-CN": "该邮箱所属企业要求通过 SSO 登录。",
    "zh-TW": "該電子郵件所屬企業要求透過 SSO 登入。",
    en: "This organization requires SSO sign-in.",
    ja: "この組織は SSO ログインが必要です。",
    ko: "이 조직은 SSO 로그인이 필요합니다.",
  },
  INVALID_RESPONSE: {
    "zh-CN": "登录服务返回了无法识别的结果，请稍后重试。",
    "zh-TW": "登入服務返回了無法識別的結果，請稍後再試。",
    en: "The sign-in service returned an unrecognized result. Try again later.",
    ja: "ログインサービスから認識できない結果が返されました。しばらくしてから再試行してください。",
    ko: "로그인 서비스에서 알 수 없는 결과를 반환했습니다. 잠시 후 다시 시도해 주세요.",
  },
  AUTH_SERVICE_UNAVAILABLE: {
    "zh-CN": "登录服务暂不可用，请稍后重试。",
    "zh-TW": "登入服務暫不可用，請稍後再試。",
    en: "The sign-in service is temporarily unavailable. Try again later.",
